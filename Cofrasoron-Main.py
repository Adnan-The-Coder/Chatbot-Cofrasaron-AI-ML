...
if "yes" == condition_for_voice:
    print(" ")
    speak("please type 1 for a male voice and 2 or 3 for a female voice")
    ...
    with open('C:\\Users\\ALI\\3D Objects\\Chat bot\\User Information','r') as Info_Read:
        ...
        if name in var_check_name and Gender in var_check_Gender:
            ...
            if "yes" in condition_for_voice:
                ...
                print(" ")
                birth_year_voice = eval(input("What's your Birth-year ?, please type here: "))
                age = str(int(current_year - birth_year_voice))
                with open('C:\\Users\\ALI\\3D Objects\\Chat bot\\User Information','w') as Info_Age:
                    Info_Age.write("Age: ")
                    Info_Age.write(age)
            else:
                ...
                print(" ")
                birth_year_non_voice = eval(input("What's your Birth-year ?, please type here: "))
                age = str(current_year - birth_year_non_voice )
                with open('C:\\Users\\ALI\\3D Objects\\Chat bot\\User Information','w') as Info_Age:
                    Info_Age.write("Age: ")
                    Info_Age.write(age)
    ...
    with open('C:\\Users\\ALI\\3D Objects\\Chat bot\\User Information','r') as Info_Read:
        ...
        if name in var_check_name and Gender in var_check_Gender:
            ...
            if "yes" in condition_for_voice:
                ...
                speak("What's your Birth-year ?")
                print(" ")
                birth_year_unknown_voice = eval(input("What's your Birth-year ?, please type here: "))
                age = str(current_year - birth_year_unknown_voice)
                with open('C:\\Users\\ALI\\3D Objects\\Chat bot\\User Information','w') as Info_Age:
                    Info_Age.write("Age: ")
                    Info_Age.write(age)
            else:
                ...
                speak("What's your Birth-year ?")
                print(" ")
                birth_year_unknown_ = eval(input("What's your Birth-year ?, please type here: "))
                age = str(current_year - birth_year_unknown_)
                with open('C:\\Users\\ALI\\3D Objects\\Chat bot\\User Information','w') as Info_Age:
                    Info_Age.write("Age: ")
                    Info_Age.write(age)
